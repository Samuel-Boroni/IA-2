...
class BFSAgent(Agent):
    ...
    def act(self):
        ...
        # Select a path from the frontier
        path = self.frontier.pop(0) #tirou o primeiro da fronteira
        ...
        viable_neighbors =  self.percepts['neighbors'] #pega os vzinhos da posicao x do signal e deixa no conjunto de percepções
        ...
        if viable_neighbors:              
            ...
            for n in viable_neighbors:
                ...
                if n not in path:
                    self.frontier = self.frontier + [path + [n]] #no final pois é largura
    ...
    def act(self):
        ...
        if viable_neighbors:              
            ...
            for n in viable_neighbors:
                ...
                if n not in path:
                    self.frontier = [path + [n]] + self.frontier #no inicio pois e profundidade
